...
async def start(bot, update):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton
                                (
                                    '🤗 Join My Groop 2 🤗', url=f"{MT_BOT_UPDATES}"
                                )
                        ]
                    ]
                )
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '⭕️ 𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛 ⭕️', url="https://t.me/Lucifer_Devil_AD"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        ...
        InlineKeyboardButton('YouDot's Add You Groop😈', callback_data="help")
    ],[
        InlineKeyboardButton('⭕️Group', url=f'{MT_GROUP}'),
        InlineKeyboardButton('Channel🔥', url=f'{MT_CHANNEL}')
    ],[
        InlineKeyboardButton('🎀 Plz Join My Groop 🎀', url='https://t.me/ADMOVEIAD')
    ]]
